...
namespace MesnacCoding
{
    ...
    public class ConfigItem
    {
        ...
        private string _CopyRight = String.Format("Copyright (C) {0} mesnac.com,All Rights Reserved", DateTime.Now.Year);
        private string _Author = "郑立兵";
        private string _AuthorEmail = "zhenglb@mesnac.com";
        private string _Online = "http://www.mesnac.com";

        private string _EntityNameSpace = "Mesnac.Entity";
        private string _EntityMapperFile = "Mesnac.Mapper";
        private string _ComponentNameSpace = "Mesnac.Data.Components";
        private string _DAONameSpace = "Mesnac.Data";
        private string _BIZNameSpace = "Mesnac.Business";
